...
public class JarInJarClassLoader extends URLClassLoader {
     ...
     * then returns a URL that can be used by the {@link cn.watchdog.essentialspro.common.loader.JarInJarClassLoader}.
     *
    ...
    private static URL extractJar(ClassLoader loaderClassLoader, String jarResourcePath) throws LoadingException {
        ...
        Path path;
        try {
            path = Files.createTempFile("essentialspro-jarinjar", ".jar.tmp");
        } catch (IOException e) {
